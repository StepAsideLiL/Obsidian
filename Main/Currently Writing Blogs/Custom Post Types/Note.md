[A Deep Dive into WordPress User Roles and Capabilities (kinsta.com)](https://kinsta.com/blog/wordpress-user-roles/)

# Bringing everything togather
This plugin registers a custom post type called `custom-post`.
```php
<?php
/**
